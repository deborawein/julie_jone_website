      ...
      >
        ...
        <form onSubmit={handleSubmit} className="w-full md:w-[40%] bg-black p-8 rounded-l-xl shadow-lg space-y-6 flex-1">
          ...
          <div className="text-center">
            <button
              type="submit"
              className='mt-6 flex items-center justify-center px-5 py-1 text-white text-2xl  bg-green-deep rounded-xl hover:bg-[#105e4b] transition-all duration-300 font-extralight'
            >
              SEND
